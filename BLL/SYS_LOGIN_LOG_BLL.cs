...
namespace BLL  
{
	///<summary>
		...
		///Author:ZhangDeng
	///</summary>
	public class SYS_LOGIN_LOG_BLL
	{	
	    #region 单例模式
		///<summary>
		///create bll instance
		///</summary>
		private static SYS_LOGIN_LOG_BLL instance;
		
		/// <summary>
        /// 私有构造函数，该类无法被实例化
        /// </summary>
        private SYS_LOGIN_LOG_BLL() { }
        ...
        /// </summary>
        /// <returns></returns>
        public static SYS_LOGIN_LOG_BLL getInstance()
        {

            if (instance == null)
            {
                instance = new SYS_LOGIN_LOG_BLL();
            }
        ...
        /// <returns></returns>
        public bool Add(SYS_LOGIN_LOG model)
        {
            bool success = false;
            using (var dbcontext = DbFactory.Create())
            {
                ...
                catch (Exception ex)
                {
                    ...
                    Logger.Error(string.Format("SYS_LOGIN_LOG_BLL 新增记录异常,异常信息:{0}", ex.ToString()));
                }
            }
        ...
        /// <returns></returns>
		public bool Remove(SYS_LOGIN_LOG model)
        {
            bool success = false;
            ...
            using (var dbcontext = DbFactory.Create())
            {
                ...
                {
                    success = false;
                    Logger.Error(string.Format("SYS_LOGIN_LOG_BLL 删除记录异常,异常信息:{0}", ex.ToString()));
                }
            }
        ...
        public bool Remove(string pkid)
        {
            ...
            using (var dbcontext = DbFactory.Create())
            {
                ...
                {
                    success = false;
                    Logger.Error(string.Format("SYS_LOGIN_LOG_BLL 根据id删除异常,异常信息:{0}", ex.ToString()));
                }
            }
        ...
        /// </summary>
        /// <returns></returns>
        public bool BulkRemove(Expression<Func<SYS_LOGIN_LOG, bool>> exp)
        {
            bool success = false;
            ...
            using (var dbcontext = DbFactory.Create())
            {
                ...
                {
                    success = false;
                    Logger.Error(string.Format("SYS_LOGIN_LOG_BLL 根据条件批量删除,异常信息:{0}", ex.ToString()));
                }
            }
        ...
        /// <returns></returns>
        public bool Update(Expression<Func<SYS_LOGIN_LOG, bool>> exp, Dictionary<string, object> dic)
        {
            bool success = false;
           	...
           	using (var dbcontext = DbFactory.Create())
            {
                ...
                {
                    success = false;
                    Logger.Error(string.Format("SYS_LOGIN_LOG_BLL 按条件更新,异常信息:{0}", ex.ToString()));
                }
            }
